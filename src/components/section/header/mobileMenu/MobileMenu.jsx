...
const MobileMenu = ({ mobileMenuhandle }) => {
  ...
  return (
    <MobileMenuStyleWrapper className="CleverMeta_mobile_menu">
      <div className="CleverMeta_mobile_menu_content">
        <div className="mobile_menu_logo">
          <img className="CleverMeta_logo" src={logo} alt="CleverMeta logo" />
          <button
        ...
        <div className="CleverMeta_mobile_menu_list">
          <ul>
        ...
        <div className="mobile_menu_social_links">
          <a href="# ">
            <img src={openseaIcon} alt="CleverMeta social icon" />
          </a>
          <a href="# ">
            <FaTwitter />
          </a>
