...
const FAQ = () => {
  ...
  return (
    <FAQStyleWrapper className="CleverMeta_faq_sect" id="faq">
      <div className="container">
        <div className="CleverMeta_faq_content">
          <SectionTitle
            isCenter={true}
          ...
          <div className="CleverMeta_faq_questions">
            ...
            <div className="faq_bg_wattermark">
              <img src={faqBgThumb} alt="CleverMeta nft faq" />
            </div>
          </div>
        </div>
      </div>
