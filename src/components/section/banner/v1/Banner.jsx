      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-6">
            <div className="CleverMeta_v1_baner_left">
              <h2>Cyber Meta 🎯 NFT collections</h2>
              <h3>
          ...
          <div className="col-lg-6">
            <div className="CleverMeta_v1_baner_right">
              <div className="CleverMeta_v1_baner_right_img_sect">
                ...
                <div className="CleverMeta_v1_baner_right_img_bg">
                  <img src={homeImageBG} alt="" />
                </div>
                <div className="CleverMeta_v1_baner_right_img">
