          ...
          <div className="row">
            <div className="col-lg-4">
              <div className="footer_image">
                <a href="# ">
                  <img src={footerLogo} alt="CleverMeta nft footer logo" />
                </a>
                <p>
                  CleverMeta is great solution for launch your NFT for minting. It
            ...
            <div className="col-md-6 col-lg-4">
              <div className="footer-menu footer_newsletter">
                ...
                <div className="form-box">
                  ...
                  />
                  <button>
                    <img src={btnArrow} alt="CleverMeta nft arrow" />
                  </button>
                </div>
              </div>
            </div>
